...
class LinuxNetwork(Network):
    ...
    def get_interfaces_info(self, ip_path, default_ipv4, default_ipv6):
        ...
        for path in glob.glob('/sys/class/net/*'):
            ...
            if os.path.exists(os.path.join(path, 'bonding_subordinate')):
                interfaces[device]['perm_macaddress'] = get_file_content(os.path.join(path, 'bonding_subordinate', 'perm_hwaddr'), default='')
