...
description: Change HA state or settings of FortiManager nodes (Standalone/Main/Subordinate).
...
options:
  fmgr_ha_mode:
    ...
    required: false
    choices: ["standalone", "main", "subordinate"]
...
def main():
    argument_spec = dict(
        fmgr_ha_mode=dict(required=False, type="str", choices=["standalone", "main", "subordinate"]),
    ...
    required_if = [
        ...
        ['fmgr_ha_mode', 'main', ['fmgr_ha_cluster_pw', 'fmgr_ha_cluster_id']],
        ['fmgr_ha_mode', 'subordinate', ['fmgr_ha_cluster_pw', 'fmgr_ha_cluster_id']],
    ]
