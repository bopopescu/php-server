...
- name: Install bos.sysmgt that includes bos.sysmgt.nim.main, bos.sysmgt.nim.spot
  installp:
    name: bos.sysmgt
    repository_path: /repository/AIX71/installp/base
    package_license: yes
...
- name: Install bos.sysmgt.nim.main only
  installp:
    name: bos.sysmgt.nim.main
    repository_path: /repository/AIX71/installp/base
    package_license: yes
    state: present

- name: Install bos.sysmgt.nim.main and bos.sysmgt.nim.spot
  installp:
    name: bos.sysmgt.nim.main, bos.sysmgt.nim.spot
    repository_path: /repository/AIX71/installp/base
    package_license: yes
    state: present

- name: Remove packages bos.sysmgt.nim.main
  installp:
    name: bos.sysmgt.nim.main
    state: absent
'''
